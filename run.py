...
"""
python run.py --queryDate 2023-03-09 --export_crs EPSG:3857 --export_dir J:/geoserver_data/ndvi_pseudo_mercator --trans_dir J:/geoserver_data/ndvi_gcj02
"""
...
parser.add_argument('--trans_dir', type=Path, default=Path('.'), help='the coordinate transformed images output directory')
